...
@interface HealthPlanTableViewCell ()
...
@end
@implementation HealthPlanTableViewCell
...
- (IBAction)joinAction:(id)sender {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(HealthPlanTableViewCellJoinAction:)]) {
        
        [self.delegate HealthPlanTableViewCellJoinAction:self.planModel];
    }
