...
+(NSString *)compareDate:(NSString *)dateString{
    ...
    NSString * dateString1 = [dateString substringToIndex:10];
    
    if ([dateString1 isEqualToString:todayString])
    {
        return @"今天";
    } else if ([dateString1 isEqualToString:yesterdayString])
    {
        return @"昨天";
    }else if ([dateString1 isEqualToString:tomorrowString])
    {
        return @"明天";
    }
    else
