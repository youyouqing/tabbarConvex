...
-(void)showNum:(NSInteger)num{
    ...
    self.avgScoreLbl.text=[NSString stringWithFormat:@"%li",num];
...
- (void)setUpdatingNumber:(CGFloat)updatingNumber
{
    ...
    NSInteger h=(NSInteger)_updatingNumber;
    self.avgScoreLbl.text = [NSString stringWithFormat:@"%li",h];
}
...
- (void)setPrecent:(CGFloat)precent description:(NSString *)description
{
    ...
    if ((NSInteger)precent==100) {
        
        self.descriptionLbl.centerx = CGRectGetMaxX(self.avgScoreLbl.frame)-4;
        
    }else{
        
        self.descriptionLbl.centerx = CGRectGetMaxX(self.avgScoreLbl.frame)-13;
...
- (void)setPrecent:(CGFloat)precent{
    _precent = precent;
    NSInteger h=(NSInteger)_precent;
    self.avgScoreLbl.text = [NSString stringWithFormat:@"%li",h];
}
...
- (void)addAnimateWithType:(int)type
{
    ...
    void(^acallBack)(CGFloat start) = ^(CGFloat start) {
        ...
        moveAction.values = [NSArray arrayWithObjects:[NSNumber numberWithFloat:-weakSelf.frame.size.width/10],[NSNumber numberWithFloat:start],nil];
        moveAction.duration = self.precent*0.3;
        self.avgScoreLbl.text=[NSString stringWithFormat:@"%li",(NSInteger)self.precent];
