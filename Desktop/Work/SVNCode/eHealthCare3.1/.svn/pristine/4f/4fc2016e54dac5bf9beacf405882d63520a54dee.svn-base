...
@implementation HealthPlanTopCell
...
- (IBAction)joinAction:(id)sender {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(HealthPlanTopCellJoinAction:)]) {
        
        [self.delegate HealthPlanTopCellJoinAction:self.planModel];
    }
