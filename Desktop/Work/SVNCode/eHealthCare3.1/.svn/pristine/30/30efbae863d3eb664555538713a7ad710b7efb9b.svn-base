...
-(void)loadData
{
    ...
    NSDictionary *dict=@{@"Token":[UserInfoTool getLoginInfo].Token,@"PhysicalExaminationID":self.PhysicalExaminationID};
    
    [[XKLoadingView shareLoadingView] showLoadingText:nil];
    [ProtosomaticHttpTool protosomaticPostWithURLString:@"339" parameters:dict success:^(id json) {
        XKLOG(@"检测详细报告339：%@",json);
...
//            if (indexPath.row == model.suggestArr.count) {
