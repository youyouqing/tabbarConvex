...
//  eHealthCare
//
//  Created by xiekang on 16/9/22.
//  Copyright © 2016年 mac. All rights reserved.
//

#import "OnlineServiceViewController.h"
#define KNOTIFICATIONNAME_DELETEALLMESSAGE @"RemoveAllMessages"
@interface OnlineServiceViewController ()<UIAlertViewDelegate,EMClientDelegate>
{
               ...
               selectAtTarget:(EaseSelectAtTargetCallback)selectedCallback
{
    ...
    if (chatGroup) {
        if (!chatGroup.occupants) {
            __weak OnlineServiceViewController* weakSelf = self;
            ...
            dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    __strong OnlineServiceViewController *strongSelf = weakSelf;
                    if (strongSelf) {
                        [strongSelf hideHud];
                        if (error) {
